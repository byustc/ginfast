...
// ThitankMemberListRequest res_thinktank_member列表请求参数
type ThitankMemberListRequest struct {
	models.BasePaging
	models.Validator
	Id *int64 `form:"id"` // 主键
...
// Validate 验证请求参数
func (r *ThitankMemberListRequest) Validate(c *gin.Context) error {
	return r.Validator.Check(c, r)
}

// Handle 获取查询条件
func (r *ThitankMemberListRequest) Handle() func(db *gorm.DB) *gorm.DB {
...
// ThitankMemberCreateRequest 创建res_thinktank_member请求参数
type ThitankMemberCreateRequest struct {
	models.Validator
	ThinktankId int64 `form:"thinktankId"` // 新研机构-数据主键id
...
// Validate 验证请求参数
func (r *ThitankMemberCreateRequest) Validate(c *gin.Context) error {
	return r.Validator.Check(c, r)
}

// ThitankMemberUpdateRequest 更新res_thinktank_member请求参数
type ThitankMemberUpdateRequest struct {
	models.Validator
...
// Validate 验证请求参数
func (r *ThitankMemberUpdateRequest) Validate(c *gin.Context) error {
	return r.Validator.Check(c, r)
}

// ThitankMemberDeleteRequest 删除res_thinktank_member请求参数
type ThitankMemberDeleteRequest struct {
	models.Validator
	Id int64 `form:"id" validate:"required" message:"主键不能为空"` // 主键
}

// Validate 验证请求参数
func (r *ThitankMemberDeleteRequest) Validate(c *gin.Context) error {
	return r.Validator.Check(c, r)
}

// ThitankMemberGetByIDRequest 根据ID获取res_thinktank_member请求参数
type ThitankMemberGetByIDRequest struct {
	models.Validator
	Id int64 `uri:"id" validate:"required" message:"主键不能为空"` // 主键
}

// Validate 验证请求参数
func (r *ThitankMemberGetByIDRequest) Validate(c *gin.Context) error {
	return r.Validator.Check(c, r)
}