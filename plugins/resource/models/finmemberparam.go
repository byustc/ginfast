...
// FinMemberListRequest res_finance_member列表请求参数
type FinMemberListRequest struct {
	models.BasePaging
	models.Validator
	Id *int64 `form:"id"` // 主键
	FinanceId *int64 `form:"financeId"` // 金融机构-数据主键id
...
// Validate 验证请求参数
func (r *FinMemberListRequest) Validate(c *gin.Context) error {
	return r.Validator.Check(c, r)
}

// Handle 获取查询条件
func (r *FinMemberListRequest) Handle() func(db *gorm.DB) *gorm.DB {
...
// FinMemberCreateRequest 创建res_finance_member请求参数
type FinMemberCreateRequest struct {
	models.Validator
	FinanceId int64 `form:"financeId"` // 金融机构-数据主键id
...
// Validate 验证请求参数
func (r *FinMemberCreateRequest) Validate(c *gin.Context) error {
	return r.Validator.Check(c, r)
}

// FinMemberUpdateRequest 更新res_finance_member请求参数
type FinMemberUpdateRequest struct {
	models.Validator
...
// Validate 验证请求参数
func (r *FinMemberUpdateRequest) Validate(c *gin.Context) error {
	return r.Validator.Check(c, r)
}

// FinMemberDeleteRequest 删除res_finance_member请求参数
type FinMemberDeleteRequest struct {
	models.Validator
	Id int64 `form:"id" validate:"required" message:"主键不能为空"` // 主键
}

// Validate 验证请求参数
func (r *FinMemberDeleteRequest) Validate(c *gin.Context) error {
	return r.Validator.Check(c, r)
}

// FinMemberGetByIDRequest 根据ID获取res_finance_member请求参数
type FinMemberGetByIDRequest struct {
	models.Validator
	Id int64 `uri:"id" validate:"required" message:"主键不能为空"` // 主键
}

// Validate 验证请求参数
func (r *FinMemberGetByIDRequest) Validate(c *gin.Context) error {
	return r.Validator.Check(c, r)
}